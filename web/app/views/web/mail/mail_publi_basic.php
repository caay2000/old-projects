					...
					<td class="w580" width="580"><repeater> <layout label="Text only">
						...
						<table class="w580" width="580" cellpadding="0" cellspacing="0"
							...
							<tbody>
								...
								<tr>
									<td class="w580" width="580"><img editable="true" label="Image"
										class="w580" width="580" border="0"></td>
								</tr>
								<tr>
						...
						</layout> <layout label="Text with right-aligned image">
						<table class="w580" width="580" cellpadding="0" cellspacing="0"
							border="0">
							<tbody>
								<tr>
										...
										<table cellpadding="0" cellspacing="0" border="0"
											...
											<tbody>
												<tr>
													...
													<td><img editable="true" label="Image" class="w300"
						...
						</layout> <layout label="Text with left-aligned image">
						<table class="w580" width="580" cellpadding="0" cellspacing="0"
							border="0">
							<tbody>
								<tr>
						...
						</layout> <layout label="Two columns">
						<table class="w580" width="580" cellpadding="0" cellspacing="0"
							border="0">
							<tbody>
								<tr>
									<td class="w275" width="275" valign="top">
										<table class="w275" width="275" cellpadding="0"
						...
						</layout> <layout label="Image gallery">
						<table class="w580" width="580" cellpadding="0" cellspacing="0"
							border="0">
							<tbody>
								<tr>
									<td class="w180" width="180" valign="top">
										<table class="w180" width="180" cellpadding="0"
											cellspacing="0" border="0">
											<tbody>
												<tr>
													<td class="w180" width="180"><img editable="true"
														label="Image" class="w180" width="180" border="0">
													</td>
												</tr>
												<tr>
