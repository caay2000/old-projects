							...
							<div class="row list-partido">
								<?php foreach($user->pronostics as $p){ ?>
									<div class="col-xs-12 col-sm-6">
										<div class="row">
											<div class="col-xs-2">
												<img class="flag" src="<?php echo MEDIA_PATH."/images/flag/".strtolower($p->partido->team1->code);?>.png" alt="<?php echo $p->partido->team1->code;?>"/>
											</div>
											<div class="col-xs-4">
										...
										<div class="row">
											<div class="col-xs-2">
												<img class="flag" src="<?php echo MEDIA_PATH."/images/flag/".strtolower($p->partido->team2->code);?>.png" alt="<?php echo $p->partido->team2->code;?>"/>	
											</div>
											<div class="col-xs-4">
