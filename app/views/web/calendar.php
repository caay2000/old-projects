<div class="row">
	...
	<div class="col-xs-12">
		<span>You can check your time in <a href="http://www.fifa.com/worldcup/" target="_blank">FIFA Official Site</a></span>
	</div>
</div>
		...
		<div class="col-xs-offset-1 col-xs-10 col-sm-offset-0 col-sm-4 col-md-3">
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<span class="no-hidden-xs"><?php echo $partido->fecha->format('H:i');?></span>
