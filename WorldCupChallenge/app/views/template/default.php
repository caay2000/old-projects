	    ...
	    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo PAGE_ROOT; ?>/">Merkle Comet - Russia 2018</a>
	        </div>
	        <div class="collapse navbar-collapse">
	          ...
	          <?php /* 
	        	...
	        	*/
	        	?>
	          	<div class="pull-right logos hidden-sm">
	          		<a href="http://www.cometgc.com/" target="_blank"><img src="<?php echo MEDIA_PATH; ?>/images/merkle_logo.png"/></a>
	          	</div>
	        </div>
	      </div>
	    </div>
